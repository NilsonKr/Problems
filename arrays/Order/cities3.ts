...
function topInObject(list: string[]): citiesDicc {
	...
	//Object with the most occurred cities
	const orderObject: citiesDicc = fallingOrder.reduce(
		(prev, current) => ({ ...prev, [current]: dicc[current] }),
		{}
	);
...
console.log(topInObject(cities));
